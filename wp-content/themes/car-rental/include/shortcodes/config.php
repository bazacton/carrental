...
define('CS_SC_VEHICLES_SEARCH','cs_vehicle_search');
define('CS_SC_SITEMAP','cs_sitemap');
define('CS_SC_VIDEO','cs_video');
define('CS_SC_DEALS','cs_deals');
define('CS_SC_DEALSITEM','deals_item');
define('CS_SC_MULTPLEDEALS','cs_multiple_deals');
define('CS_SC_MULTPLEDEALSITEM','multiple_deals_item');
//Translation
esc_html__('Call To Action','car-rental');
esc_html__('Contactus','car-rental');
esc_html__('Faq','car-rental');
esc_html__('Flex Column','car-rental');
esc_html__('Teams','car-rental');
esc_html__('Mail chimp','car-rental');
esc_html__('Price table','car-rental');
esc_html__('Promo box','car-rental');
esc_html__('Progress bars','car-rental');
