...
if ( ! function_exists( 'cs_pb_mailchimp' ) ) {
    function cs_pb_mailchimp($die = 0){
		...
		'cs_mailchimp_title'=> 'Login for Newsletter',
		'cs_mailchimp_subtitle' => '',
		'cs_mailchimp_bg_color' => '',
		'cs_mailchimp_txt_color' => '',
		'cs_mailchimp_text'=> 'Stay as productive on the road as you are in your office with our fantastic services.' 
		);
...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="mailchimp" data="<?php echo cs_element_size_data_array_index($mailchimp_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[<?php echo esc_attr( CS_SC_MAILCHIMP );?> {{attributes}}]{{content}}[/<?php echo esc_attr( CS_SC_MAILCHIMP );?>]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php esc_html_e('Edit Mail Chimp Options','car-rental');?></h5>
    ...
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php esc_html_e('Mail chimp Title','car-rental');?></label>
          </li>
          <li class="to-field">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php esc_html_e('Mailchimp Sub Title','car-rental');?></label>
          </li>
          <li class="to-field">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php esc_html_e('Mailchimp Text','car-rental');?></label>
          </li>
          <li class="to-field">
            <textarea rows="20" cols="40" name="cs_mailchimp_text[]" data-content-text="cs-shortcode-textarea"><?php echo esc_textarea($cs_mailchimp_text)?></textarea>
            <div class='left-info'><p><?php esc_html_e('Enter content here','car-rental');?></p></div>
          </li>
        </ul>
