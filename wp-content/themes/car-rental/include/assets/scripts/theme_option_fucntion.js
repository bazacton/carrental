function theme_option_save(admin_url){
	"use strict";
...
function cs_set_filename( file_value, admin_url, file_path ){
	"use strict";
...
function cs_add_banner_fields(admin_url, theme_url, id){
	...
	if ( banner_field != "" && check_field_value != "" ) {
		jQuery("#banner-loader").html("<img src='" + theme_url + "/include/assets/images/ajax_loading.gif' alt='banner'/>");
