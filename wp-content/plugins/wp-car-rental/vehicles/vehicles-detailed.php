...
<div class="cs-listing simple-view" data-admin_url="<?php echo admin_url('admin-ajax.php'); ?>">
    <div class="col-md-12">
        <?php
            ...
            while ($query->have_posts()) : $query->the_post();
                ...
                <article class="<?php echo absint($cs_post_id); ?>">
                    ...
                    <div class="listing-text"> <span class="cs-categroies"></span>
                        ...
                        <?php } ?>
                        <h3><a data-toggle="modal" data-target="#car-rental-popup-<?php echo absint($cs_post_id); ?>" href="<?php echo get_the_permalink($cs_post_id); ?>"><?php echo get_the_title($cs_post_id); ?></a></h3>
						...
						if (isset($cs_vehicle_price) && $cs_vehicle_price != '') { ?>
                            <div class="price-box pull-left">
                                <div class="current-price">
                                    <span><?php _e('Price Start From', 'rental'); ?><em class="new-price"><?php echo esc_html($currency_sign . $cs_vehicle_price); ?></em></span>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="info-btn pull-right cs-book-vehicle"> 
                            ...
                            <a href="javascript:;" data-toggle="modal" data-target="#car-booking-popup-div" class="book-btn reserve-vehicle-btn"><?php _e('Book Now', 'rental'); ?></a> </div>
                    </div>
                    <?php echo cs_get_detail($cs_post_id, 'starting'); ?>
                    <!--Invite-->
