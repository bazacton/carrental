...
class cs_widget_data {
    ...
    public static function enqueue_admin_scripts($hook) {
        ...
        wp_enqueue_style('widget_data', wp_car_rental::plugin_url() . 'assets/css/widget-data.css');
        wp_enqueue_script('widget_data', wp_car_rental::plugin_url() . 'assets/scripts/widget-data.js', '', '', true);
    ...
    public static function cs_import_widget_data() {
        ...
        $cs_upload_dir = wp_car_rental::plugin_dir() . 'include/cs-importer/import-widgets/';
        ...
        echo '<p><strong>' . __('Widgets Imported Successfully.', 'rental') . '</strong><br />';
    }
